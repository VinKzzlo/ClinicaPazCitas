    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="row align-items-center mb-3">
                <div class="col d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold m-0">Seguros Médicos</h5>
                    <asp:LinkButton ID="btnRegistrar" CssClass="btn btn-success"
                        runat="server" OnClick="btnRegistrar_Click"
                        Text="Registrar Seguro <i class='fa-solid fa-square-plus ms-1'></i>" />
                </div>
            </div>
        </div>
        <div class="container row">
            <asp:GridView ID="gvSeguros" runat="server"
                ...
                AutoGenerateColumns="false" PageSize="7" AllowPaging="true" OnPageIndexChanging="gvSeguros_PageIndexChanging"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="% Cobertura" DataField="porcentajeCobertura" DataFormatString="{0:0.00} %" HtmlEncode="false"
                        HeaderStyle-CssClass="bg-success text-white align-middle"
                        ItemStyle-Width="15%" ItemStyle-CssClass="text-wrap align-middle" />
                    <asp:BoundField HeaderText="Vigencia" DataField="vigencia" DataFormatString="{0:dd-MM-yyyy}" HtmlEncode="false"
                        HeaderStyle-CssClass="bg-success text-white align-middle"
