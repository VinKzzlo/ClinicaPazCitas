...
public class NotaClinicaImpl implements NotaClinicaDAO {
    ...
    public int insertar(NotaClinica nota) {
        ...
        parametrosEntrada.put(6, nota.getTriaje().getIdTriaje());
        parametrosEntrada.put(7, nota.getReceta().getIdReceta());
        parametrosEntrada.put(8, nota.getHistorial().getIdhistorial());
    ...
    public ArrayList<NotaClinica> listarTodos() {
        ...
        rs = DBManager.getInstance().ejecutarProcedimientoLectura("LISTAR_NOTAS_CLINICAS_TODAS", null);
